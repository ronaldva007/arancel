...
<?php echo $this->Form->create('EstatusSolicitud'); ?>
	<fieldset>
		<legend><?php echo __('Edit Estatus Solicitud'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EstatusSolicitud.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('EstatusSolicitud.id'))); ?></li>
