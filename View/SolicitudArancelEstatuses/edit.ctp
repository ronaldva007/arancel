...
<?php echo $this->Form->create('SolicitudArancelEstatus'); ?>
	<fieldset>
		<legend><?php echo __('Edit Solicitud Arancel Estatus'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SolicitudArancelEstatus.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('SolicitudArancelEstatus.id'))); ?></li>
