...
<?php echo $this->Form->create('TipoSolicitud'); ?>
	<fieldset>
		<legend><?php echo __('Edit Tipo Solicitud'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TipoSolicitud.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('TipoSolicitud.id'))); ?></li>
